...
type Response struct {
	...
	Sub float32 `protobuf:"fixed32,1,opt,name=sub,proto3" json:"sub,omitempty"`
}
...
func (x *Response) GetSub() float32 {
	if x != nil {
		return x.Sub
	}
	return 0
...
var file_sub_proto_rawDesc = []byte{
	...
	0x75, 0x62, 0x18, 0x01, 0x20, 0x01, 0x28, 0x02, 0x52, 0x03, 0x73, 0x75, 0x62, 0x32, 0x3a, 0x0a,
	0x0a, 0x53, 0x75, 0x62, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2c, 0x0a, 0x0b, 0x53,
	0x75, 0x62, 0x32, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x12, 0x0c, 0x2e, 0x73, 0x75, 0x62,
	0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0d, 0x2e, 0x73, 0x75, 0x62, 0x2e, 0x52,
...
var file_sub_proto_goTypes = []interface{}{
	(*Request)(nil),  // 0: sub.Request
	(*Response)(nil), // 1: sub.Response
}
var file_sub_proto_depIdxs = []int32{
	0, // 0: sub.SubService.Sub2Numbers:input_type -> sub.Request
	1, // 1: sub.SubService.Sub2Numbers:output_type -> sub.Response
